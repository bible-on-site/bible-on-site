    ...
    let req = pdf::PdfRequest {
        ...
        perakim: vec![pdf::PdfPerekInput {
            ...
            articles: vec![(
                ...
                concat!(
                    "<h2>פתיחה</h2>",
                    "<p>תוכן המאמר כאן. זהו פסקה ראשונה עם <b>טקסט מודגש</b> ",
                    "ו<i>טקסט נטוי</i> בתוכה.</p>",
                    "<h3>חלק שני</h3>",
                    "<p>פסקה שנייה של המאמר עם תוכן מפורט יותר.</p>",
                    "<blockquote>ציטוט חשוב מתוך מקור קדום.</blockquote>",
                    "<p>וסיום המאמר.</p>",
                ).to_string(),
            )],
        }],
