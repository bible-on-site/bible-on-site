...
const ReadModeToggler = forwardRef<HTMLLabelElement, { toggled: boolean; onToggle?: (toggled: boolean) => void }>(
  function ReadModeToggler(props, ref) {
    ...
    return (
      <label ref={ref ?? toggleRef} className={styles.label}>
        <input className={styles.input} id="toggle" type="checkbox" checked={toggled} onChange={handleChange} />
