import { getPerekByPerekId, getPerekIdByDate, getTodaysPerekId } from "../../../src/data/perek-dto";
...
describe("getPerekIdByDate", () => {
  ...
  describe("before 1st cycle (I.E. 22 Kislev 5774)", () => {
    it("returns 1st perek", () => {
      const actual = getPerekIdByDate(parseKosherChristianDate("14/December/14"));
  ...
  describe("after last cycle (I.E. 29 Elul 5938)", () => {
    it("returns last perek (929)", () => {
      const actual = getPerekIdByDate(parseKosherChristianDate("29/September/38"));
