...
# where module_path is one of: app, web/api, web/admin, web/bible-on-site, web/bulletin

module_path="$1"

if [ -z "$module_path" ]; then
    echo "Usage: shared-checks.sh <module_path>"
    echo "  module_path: app, web/api, web/admin, web/bible-on-site, or web/bulletin"
    exit 1
fi
