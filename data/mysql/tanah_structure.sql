-- Combined Tanah database structure (for backward compatibility)
-- This file is DEPRECATED for direct use. Prefer using the split files:
--   - tanah_static_structure.sql  (sefarim, perakim, dates - rarely changes)
--   - tanah_dynamic_structure.sql (articles, dedications, authors - changes frequently)
--
-- For tests: Set @db_name='tanah_test' before sourcing
-- For prod:  Set @db_name='tanah' before sourcing
-- If @db_name is not set, defaults to 'tanah_test'
--
-- Usage:
--   mysql -e "SET @db_name='tanah_test';" -e "SOURCE tanah_structure.sql"
--   Or use db-populator which handles this automatically
-- Initialize database (set @db_name before this if needed)
SET @db_name = IFNULL(@db_name, 'tanah_test');
...
;
-- ============================================================================
-- STATIC STRUCTURE (sefarim, perakim, dates - from tanah_static_structure.sql)
-- ============================================================================
--
...
;
-- ============================================================================
-- DYNAMIC STRUCTURE (articles, dedications, authors - from tanah_dynamic_structure.sql)
-- ============================================================================
--
