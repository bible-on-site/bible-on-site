-- Demo family graph for שמשון (parents, three wives as separate unions — נישואין לפי משנה תורה הלכות איסורי ביאה יג טז, שגיורן כדת).
...
-- כל אשה בשורה אחת (ללא alt_group) — נישואין תקפים, לפי גיורן כדת; מקור אישי משלה לכל אשה ב-person_source_citation.
